...
RUN_ID="$(date +%Y%m%d_%H%M%S)_doubao_headsft_r8"
...
PARAMS_JSON="$ROOT_DIR/grid_params_two_stage_head_then_sft_round8.json"
...
PY3
  ...
  echo "[DONE] doubao two-stage head-then-sft round8 finished"
